...
- Additional colour options added to the annotations colour palette
- Certain basemaps can now be 'overzoomed' beyond their normal levels, allowing you to zoom closer (albeit at reduced quality)
- Fixed various bugs including
  - Attributions not shown for vector layers
  - Filtering using certain characters did not work
  - Height of certain modals and panels was incorrect on mobile
  - A random annotation at coordinates 0,0 was being added when annotating, and was included in exports
...
- You can search for Plus Code locations in the search bar, as well as all the usual searches
